...
SELECT d.id_dispensacao, d.id_paciente_externo, d.id_receita_externa, d.data_dispensacao, d.status, d.valor_total,
	   u.nome AS farmaceutico, m.nome_comercial, m.principio_ativo, i.quantidade, i.dosagem, i.subtotal
FROM dispensacao d
...
BEGIN
    ...
    VALUES (v_id_dispensacao, p_id_usuario, 'DISPENSACAO', 'SUCESSO', 'Receita ' || p_id_receita || ' dispensada');
	--
END;
$$;
--
